            ...
            <div class="row clearfix">
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                     <div class="card bg-teal">
                                <p align="center">Lihat Data MBKM</p></div>
                    <div class="card">
                        <div class="header">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><?= $prodi->koordinator_jurusan?></td>
                                                ...
                                                <td width="20px"><?php echo anchor('admin/mbkm/C_data/detail/'.$prodi->id_jurusan, 
                            ...
                            <?php echo anchor('admin/mbkm/C_data/index/', '<button class="btn btn-sm btn-danger">Kembali</div>')?>
                        </div>
                    </div>
                </div>
            </div>
