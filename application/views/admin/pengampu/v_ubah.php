        ...
        <div class="container-fluid">
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <form action="<?= base_url()?>admin/C_pengampu/update" method="post" >
                        <div class="body">
                            
                            <?php foreach($pengampu2 as $dosen):?>
                                <div class='form-group'>
                                    <label>Prodi</label>
                                    <select class='form-control' id='prodi' name="prodi">
                                        <option value='<?php echo $dosen->id_jurusan; ?>'><?php echo $dosen->nama; ?></option>
                                        <?php 
                                ...
                                <div class='form-group'>
                                    ...
                                    <select class='form-control' id='matkul' name="matkul" required>
                                        <option value='<?php echo $dosen->id_matkul; ?>'><?php echo $dosen->nama_matkul; ?></option>
                                    </select>
                                </div>
                                ...
                                <div class='form-group'>
                                    ...
                                    <select class='form-control' id='koordinator' name="koordinator" required>
                                        <option value='<?php echo $dosen->koordinator; ?>'><?php echo $dosen->koordinator; ?></option>
                                    </select>
                                </div>
                                ...
                                <div class='form-group'>
                                    <label>Kelas</label>
                                    <div class="form-line">
                                    <input type="text" name="kelas" class="form-control" value="<?php echo $dosen->kelas;  ?>" required>
                                    <input type="hidden" class="form-control" name="id_pengampu" value="<?php echo $dosen->id_pengampu;  ?>">
                                </div>
                                </div>
                            <?php endforeach; ?>
