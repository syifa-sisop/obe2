                ...
                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                    <div class="card">
                      ...
                      ?>
                        <div class="header">
                            <h2>
                                Setting data prodi yang akan dilihat / dikelola
                            </h2>
                        </div>
                        <div class="body">
                            <?php echo form_open_multipart('kurikulum/C_prodi/setting'); ?>
                            ...
                            <select name="prodi" class="form-control"  required>
                             ...
                             <button type="submit" class="btn btn-block btn-lg bg-indigo waves-effect">Setting</button>
                             <?php echo form_close() ?>
                            <hr>
