                        ...
                        <div class="body">
                            ...
                            <div class="tab-content">
                                <div role="tabpanel" class="tab-pane fade in active" id="home_with_icon_title">
                                    ...
                                    <a class="btn btn-warning" href="<?php echo base_url('dosen/C_matriks/pdf_profil') ?>" target="_blank"><i class="material-icons">insert_drive_file</i> Export (Pdf)</a>
                                ...
                                <div role="tabpanel" class="tab-pane fade" id="profile_with_icon_title">
                                    ...
                                    <a class="btn btn-warning" href="<?php echo base_url('dosen/C_matriks/pdf_kajian') ?>" target="_blank"><i class="material-icons">insert_drive_file</i> Export (Pdf)</a>
                                ...
                                <div role="tabpanel" class="tab-pane fade" id="messages_with_icon_title">
                                    <a class="btn btn-warning" href="<?php echo base_url('dosen/C_matriks/pdf_matkul') ?>" target="_blank"><i class="material-icons">insert_drive_file</i> Export (Pdf)</a>
                                ...
                                <div role="tabpanel" class="tab-pane fade" id="settings_with_icon_title">
                                    ...
                                    <a class="btn btn-warning" href="<?php echo base_url('dosen/C_matriks/pdf_kajianmk') ?>" target="_blank"><i class="material-icons">insert_drive_file</i> Export (Pdf)</a>
