        ...
        <div class="container-fluid">
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <?php echo form_open_multipart('dosen/C_rps/insert_subcpmk/'.$data->id_matkul.'/'.$data->id_pengampu); ?>
                        <div class="body">
                        
                                <div class='form-group'>
                                    <label>Kode Sub-CPMK</label>
                                    <div class="form-line">
                                    <input type="text" name="kode_subcpmk" class="form-control" required>
                                </div>
                                </div>
                                ...
                                <div class='form-group'>
                                    ...
                                    <textarea rows="3" class="form-control no-resize auto-growth" name="subcpmk"></textarea>
                                </div>
                                </div>
                                ...
                                <div class='form-group'>
                                    ...
                                    <div class="form-line">
                                    <input type="text" name="kode_baru" class="form-control" required>
                                </div>
                                </div>
                                ...
                                <div class='form-group'>
                                    ...
                                    <select class='form-control' id='id_cplmk' name="id_cplmk">
                                        <option value='0'>--pilih CPL MK--</option>
