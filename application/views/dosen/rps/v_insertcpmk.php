        ...
        <div class="container-fluid">
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <?php echo form_open_multipart('dosen/C_rps/insert_cpmk/'.$data->id_matkul.'/'.$data->id_pengampu); ?>
                        <div class="body">
                                ...
                                <div class='form-group'>
                                    ...
                                    <div class="form-line">
                                    <textarea rows="3" class="form-control no-resize auto-growth" name="cpmk"></textarea>
                                </div>
                                </div>
                                ...
                                <div class='form-group'>
                                    ...
                                    <select class='form-control' id='id_cpl' name="id_cpl">
                                        <option value='0'>--pilih CPL--</option>
                                        <?php 
