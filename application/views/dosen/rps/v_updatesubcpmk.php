                    ...
                    <div class="card">
                        ...
                        <div class="body">
                                ...
                                <div class='form-group'>
                                    ...
                                    <div class="form-line">
                                    <input type="hidden" class="form-control" name="id_subcpmk" value="<?= $dosen->id_subcpmk ?>">
                                    <input type="text" name="kode_subcpmk" class="form-control" value="<?= $dosen->kode_subcpmk ?>" required>
                                </div>
                                </div>
                                ...
                                <div class='form-group'>
                                    ...
                                    <div class="form-line">
                                    <textarea rows="3" class="form-control no-resize auto-growth" name="subcpmk"><?= $dosen->subcpmk ?></textarea>
                                </div>
                                </div>
                                ...
                                <div class='form-group'>
                                    ...
                                    <div class="form-line">
                                    <input type="text" name="kode_baru" class="form-control" value="<?= $dosen->kode_baru ?>" required>
                                </div>
                                </div>

                                <div class='form-group'>
                                     <input type="hidden" class="form-control" name="id_matkul" value="<?= $data->id_matkul ?>">
                                    <label>CPL MK</label>
                                    <select class='form-control' id='id_cplmk' name="id_cplmk">
                                        <option value='<?= $dosen->id_cplmk ?>'><?= $dosen->kode_cpl ?> <?= $dosen->cpl ?></option>
                                        <?php  foreach($cplmk2 as $cpl) {
                                        echo "<option value='$cpl[id_cplmk]'>$cpl[kode_cpl] $cpl[cpl]</option>";
                                        }
                                        ?>
                                    </select>
                                </div>
                        ...
                        <div class="card-footer ">
                            <div class="modal-footer justify-content-between">
                                <?php echo anchor('dosen/C_rps/index/'.$data->id_matkul.'/'.$data->id_pengampu.'/'.$data->id_pengampu, '<div class="btn btn-sm btn-danger">Kembali</div>')?>
