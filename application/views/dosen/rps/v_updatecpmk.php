        ...
        <div class="container-fluid">
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <?php foreach($cpmk2 as $dosen):?>
                        <?php echo form_open_multipart('dosen/C_rps/update_cpmk/'.$data->id_matkul.'/'.$dosen->id_cpmk.'/'.$data->id_pengampu); ?>
                        <div class="body">
                            
                                <div class='form-group'>
                                    <label>Kode CPMK</label>
                                    <div class="form-line">
                                        <input type="hidden" class="form-control" name="id_cpmk" value="<?= $dosen->id_cpmk ?>">
                                    <input type="text" name="kode_cpmk" value="<?php echo $dosen->kode_cpmk; ?>" class="form-control" required>
                                </div>
                                </div>
                                ...
                                <div class='form-group'>
                                    ...
                                    <div class="form-line">
                                    <textarea rows="3" class="form-control no-resize auto-growth" name="cpmk"><?php echo $dosen->cpmk; ?></textarea>
                                </div>
                                </div>
                                ...
                                <div class='form-group'>
                                    ...
                                    <select class='form-control' id='id_cpl' name="id_cpl">
                                        <option value='<?php echo $dosen->id_cpl; ?>'><?php echo $dosen->kode_cpl; ?></option>
                                        <?php 
                                        foreach ($cplmk as $cplmk) {
                                        echo "<option value='$cplmk[id_cpl]'>$cplmk[kode_cpl]</option>";
                                        }
                                        ?>
                                    </select>
                                </div>
